...
## <a id="LO9.2"> LO 9.2: Generate a count matrix for a single-cell RNAseq dataset </a>
...
**Task**: Inspect the raw (unfiltered) count matrix. On the command line type the following command:
