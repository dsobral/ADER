...
### LO 9.2: Obtaining a UMI count matrix using *cellranger* or *Drop-seq tools*

The first step in scRNA-seq data analysis is to obtain a matrix of UMI counts from the raw fastq files. This process involves two major steps:
...
### Using *cellranger* to obtain a UMI count matrix for a 10x dataset
